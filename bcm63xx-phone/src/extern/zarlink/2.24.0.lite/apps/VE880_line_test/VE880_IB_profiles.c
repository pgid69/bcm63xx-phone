...
/* Device Configuration Data - VE880 Tracker 100V Inverting Boost, PCM/MPI Interface */
const VpProfileDataType IB_DEV_PROFILE[] =
{
...
const VpProfileDataType IB_AC_600_FXS[] =
{
  /* AC Profile */
...
const VpProfileDataType IB_DC_25MA_CC[] =
{
 /* DC Profile */
...
const VpProfileDataType IB_RING_25HZ_SINE[] =
{
...
/* end of file VE880_IB_profiles.c */
